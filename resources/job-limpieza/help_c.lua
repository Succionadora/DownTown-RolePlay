...
addEventHandler( getResourceName( resource ) .. ":introduce", root,
	function( )
		exports.gui:hint( "Tu trabajo: Limpiador", "Es fácil, sigue la ruta y párate en los puntos verdes.", 1 )
			...
			addEventHandler( "onClientColShapeHit", sphere,
				function( element )
					if element == getLocalPlayer( ) then
						...
						exports.gui:hint( "Tu trabajo: Limpiador", "Sube a un camión de la basura." )
					end
				end
			)
		end
