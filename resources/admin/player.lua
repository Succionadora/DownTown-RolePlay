...
addCommandHandler( "genero",
	function( player, commandName, otherPlayer, genero )
		if not hasObjectPermissionTo( player, "command.modchat", true ) then return end
...
addCommandHandler( { "staffduty", "adminduty", "modduty", "helperduty" },
	function( player, commandName )
		...
		if hasObjectPermissionTo(player, 'command.modchat', true) then
...
-- addCommandHandler( "vip",
	-- function( player, commandName )
		...
		-- if hasObjectPermissionTo(player, 'command.vip', true) then
