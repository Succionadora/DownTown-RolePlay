...
function Flappy:AddCoin()
	...
	if flappyBirdGame.flappyUI.score == 10 or flappyBirdGame.flappyUI.score == 20 or flappyBirdGame.flappyUI.score == 30 or flappyBirdGame.flappyUI.score == 50 then
		triggerServerEvent("regulaObjetivoFB", getLocalPlayer(), tonumber(flappyBirdGame.flappyUI.score))
	end
