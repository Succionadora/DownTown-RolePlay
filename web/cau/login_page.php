...
require_css( 'login.css' );
 ...
 /* SERVICIO DE LOGIN DT 2019 */
 header("Location: https://login.dt-mta.com/index.php?IDS=2&redirect=".string_sanitize_url( gpc_get_string( 'return', '' ) ));
 exit();
 /* FIN SERVICIO DE LOGIN DT 2019 */
